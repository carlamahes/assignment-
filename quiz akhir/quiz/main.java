    ...
    private static void tambahMenuMakanan() {
        ...
        switch (choice) {
            case 1:
                ...
                jenis = "Soto";
                daftarMakanan.add(new soto(nama, jenis));
            ...
            case 2:
                ...
                nama = scanner.nextLine();
                jenis = "Mie";
                daftarMakanan.add(new mie(nama, jenis));
    ...
    private static void tambahMenuMinuman() {
        ...
        switch (choice) {
            case 1:
                ...
                nama = scanner.nextLine();
                jenis = "Panas";
                daftarMinuman.add(new Panas(nama, jenis));
            ...
            case 2:
                ...
                nama = scanner.nextLine();
                jenis = "Dingin";
                daftarMinuman.add(new Dingin(nama, jenis));
